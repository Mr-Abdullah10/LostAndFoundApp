package com.abdullah.lostfound.dataSource
...
class CloudinaryUploadHelper() {
    companion object{
        fun initializeCloudinary(context: Context) {
            val config = mapOf(
                "cloud_name" to "dthhdtegi",  // Replace with your Cloudinary cloud name
                "api_key" to "471835361341584",       // Replace with your Cloudinary API key
                "api_secret" to "Q-khyoo8_kcpbk5SWVJVjppMyYg" // Replace with your Cloudinary API secret
            )
